      ...
      <div className="flex flex-col gap-5 border border-bone/20 p-8">
        ...
        <p className="text-sm leading-relaxed text-bone/55">
          {variant === "interest"
            ...
            : "When Kenya releases an opening, it is offered to one person at a time, in order. You will have an exclusive 60-minute window to claim it with the deposit."}
        </p>
