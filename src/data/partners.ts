...
export const partners: Partner[] = [
  { id: "pt-1", name: "Marguerite Hale Studio", category: "photographers", city: "Atlanta, GA", blurb: "Editorial portraiture with a film sensibility.", preferred: true, status: "active", media: { id: "partner-1", alt: "Photographer's studio light", ratio: "landscape" } },
  ...
  { id: "pt-8", name: "Ilex & Bloom", category: "florists", city: "Atlanta, GA", blurb: "Sculptural florals for weddings and events.", preferred: true, status: "active", media: { id: "partner-8", alt: "Floral arrangement in studio", ratio: "landscape" } },
